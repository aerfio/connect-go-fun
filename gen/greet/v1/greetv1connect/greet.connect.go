...
import (
	v1 "aerf.io/connect-go-fun/gen/greet/v1"
...
const (
	...
	// GreetServiceCreateUserProcedure is the fully-qualified name of the GreetService's CreateUser RPC.
	GreetServiceCreateUserProcedure = "/greet.v1.GreetService/CreateUser"
)
...
var (
	...
	greetServiceCreateUserMethodDescriptor = greetServiceServiceDescriptor.Methods().ByName("CreateUser")
)
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		...
		createUser: connect.NewClient[v1.CreateUserRequest, v1.CreateUserResponse](
			httpClient,
			baseURL+GreetServiceCreateUserProcedure,
			connect.WithSchema(greetServiceCreateUserMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
// CreateUser calls greet.v1.GreetService.CreateUser.
func (c *greetServiceClient) CreateUser(ctx context.Context, req *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	greetServiceCreateUserHandler := connect.NewUnaryHandler(
		GreetServiceCreateUserProcedure,
		svc.CreateUser,
		connect.WithSchema(greetServiceCreateUserMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	return "/greet.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case GreetServiceCreateUserProcedure:
			greetServiceCreateUserHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedGreetServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("greet.v1.GreetService.CreateUser is not implemented"))
}
